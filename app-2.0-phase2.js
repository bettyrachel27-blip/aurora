...
function render(){
 ...
 renderPageContexts();renderRhythm();renderAgenda();renderTasks();renderRoutines();renderBudget();renderProjects();renderNotifications();renderStats();renderAssistantInsights();
}
...
if("serviceWorker"in navigator){
  navigator.serviceWorker.register("service-worker.js?v=200").then(reg=>reg.update()).catch(()=>{});
}