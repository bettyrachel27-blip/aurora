const CACHE='aurora-3.0-cloud-v1';
const ASSETS=['./','./index.html','./style-3.0.css?v=300','./app-3.0.js?v=300','./manifest.webmanifest','./icon-192.png','./icon-512.png','./assets/aurora-woman-clean.webp','./assets/lily-elegant.svg','./assets/lotus-gold.svg'];
